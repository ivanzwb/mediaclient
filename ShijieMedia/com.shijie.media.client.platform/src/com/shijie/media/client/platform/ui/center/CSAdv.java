...
public class CSAdv implements IView {
	...
	public void init() {
		...
		advList = (List<String>)config.getProps().get(Constraints.CS_ADV_LIST);
		linkList = (List<String>)config.getProps().get(Constraints.CS_LINK_LIST);
		scrollTime = (Integer) config.getProps().get(Constraints.CS_SCROLLTIME);
	}
	...
	public JComponent getView() {
		...
		label.setPreferredSize(new Dimension(getWidth()-460,25));
