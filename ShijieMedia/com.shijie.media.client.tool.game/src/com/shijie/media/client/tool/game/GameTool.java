package com.shijie.media.client.tool.game;
...
public class GameTool implements ITool {
	...
	public void init(Config config) {
		if(config!=null){
			...
			order = (Integer)ignoreNull(config.getProps().get(IModule.MODULE_URL),url);	
		}
		...
		if(toolBut==null){
			...
			toolBut.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					final ActionEvent event = new ActionEvent(toolBut,IEvent.NO_DECORATED_BROWSER,url);
